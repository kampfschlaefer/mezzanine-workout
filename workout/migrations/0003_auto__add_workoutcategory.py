...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkoutCategory'
        db.create_table(u'workout_workoutcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'workout', ['WorkoutCategory'])

        # Adding M2M table for field categories on 'Workout'
        m2m_table_name = db.shorten_name(u'workout_workout_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workout', models.ForeignKey(orm[u'workout.workout'], null=False)),
            ('workoutcategory', models.ForeignKey(orm[u'workout.workoutcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['workout_id', 'workoutcategory_id'])


    def backwards(self, orm):
        # Deleting model 'WorkoutCategory'
        db.delete_table(u'workout_workoutcategory')

        # Removing M2M table for field categories on 'Workout'
        db.delete_table(db.shorten_name(u'workout_workout_categories'))
